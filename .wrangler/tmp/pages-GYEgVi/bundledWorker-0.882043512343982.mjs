...
// ../.wrangler/tmp/bundle-41aHaD/checked-fetch.js
...
// ../server/assets/index.qwik-KjuvxCYD.js
...
var Es = class {
  ...
  get(e, n) {
    ...
    let $3, c;
    if (r && ($3 = r.$subscriber$), !(2 & s) || n in e && !Yr((l = e[M]) == null ? void 0 : l[n]) || ($3 = null), i ? (c = i.value, $3 = null) : c = e[n], $3) {
      const a = A(e);
      this.$manager$.$addSub$($3, a ? void 0 : n);
    }
    return o ? Zr(c, this.$containerState$) : c;
  }
  set(e, n, s) {
    if (typeof n == "symbol")
      return e[n] = s, true;
...
var de = (t2, e, n) => {
  ...
  const s = e.$element$, r = e.$componentQrl$, o = e.$props$, i = B(t2.$static$.$locale$, s, void 0, "qRender"), $3 = i.$waitOn$ = [], c = oe(t2);
  c.$cmpCtx$ = e, c.$slotCtx$ = void 0, i.$subscriber$ = [0, s], i.$renderCtx$ = t2, r.$setContainer$(t2.$static$.$containerState$.$containerEl$);
  const l = r.getFn(i);
  return Re(() => l(o), (a) => k(nt() ? k(Rt($3), () => k(Wo(t2.$static$.$containerState$, t2), () => Rt($3))) : Rt($3), () => {
    ...
    return hn(a, s, t2), { node: Sn, rCtx: c };
  });
};
...
var _c = async (t2, e) => {
  ...
  const o = $o(), i = Ts(o, r), $3 = e.beforeContent ?? [], c = { $static$: { $contexts$: [], $headNodes$: n === "html" ? $3 : [], $locale$: (m2 = e.serverData) == null ? void 0 : m2.locale, $textNodes$: /* @__PURE__ */ new Map() }, $projectedChildren$: void 0, $projectedCtxs$: void 0, $invocationContext$: void 0 }, l = (f2 = e.serverData) == null ? void 0 : f2.locale, a = e.containerAttributes, u = a["q:render"];
  ...
  const d2 = n === "html" ? [t2] : [$3, t2];
  n !== "html" && (a.class = "qc\u{1F4E6}" + (a.class ? " " + a.class : ""));
  const p2 = r.$serverData$ = { ...r.$serverData$, ...e.serverData };
  p2.containerAttributes = { ...p2.containerAttributes, ...a }, (c.$invocationContext$ = B(l)).$renderCtx$ = i;
  const v3 = xt(n, null, a, d2, Ot | ht, null);
  r.$hostsRendering$ = /* @__PURE__ */ new Set(), await Promise.resolve().then(() => lo(v3, i, c, e.stream, r, e));
};
...
var Ms = (t2, e, n, s, r, o, i, $3) => {
  var w2;
  const c = t2.props, l = c["q:renderFn"];
  if (l)
    return e.$componentQrl$ = l, po(s, r, o, e, t2, i, $3);
  let a = "<!--qv" + fo(c);
  const u = "q:s" in c, d2 = t2.key != null ? String(t2.key) : null;
  u && ((w2 = s.$cmpCtx$) == null || w2.$id$, a += " q:sref=" + s.$cmpCtx$.$id$), d2 != null && (a += " q:key=" + d2), a += "-->", o.write(a);
  const p2 = t2.props[F];
  if (p2)
  ...
  return k(v3, () => {
    ...
    let m2;
    if (u) {
      const y2 = (f2 = r.$projectedChildren$) == null ? void 0 : f2[d2];
      if (y2) {
        const [S3, h2] = r.$projectedCtxs$, b2 = oe(S3);
        b2.$slotCtx$ = e, r.$projectedChildren$[d2] = void 0, m2 = X(y2, b2, h2, o, i);
      }
    }
...
var po = (t2, e, n, s, r, o, i) => (mo(t2, s, r.props.props), k(de(t2, s), ($3) => {
  const c = s.$element$, l = $3.rCtx, a = B(e.$static$.$locale$, c, void 0);
  a.$subscriber$ = [0, c], a.$renderCtx$ = l;
  const u = { $static$: e.$static$, $projectedChildren$: ho(r.children, e), $projectedCtxs$: [t2, e], $invocationContext$: a }, d2 = [];
  if (s.$appendStyles$) {
    const m2 = 4 & o ? e.$static$.$headNodes$ : d2;
  ...
  return s.$id$ = p2, e.$static$.$contexts$.push(s), Ms(w2, s, d2, l, u, n, o, (m2) => {
    if (s.$flags$ & ht) {
...
var yn = (t2, e, n, s, r, o) => {
  ...
  if (typeof i == "string") {
    const a = t2.key, u = t2.props, d2 = t2.immutableProps || O, p2 = he(1), v3 = p2.$element$, w2 = i === "head";
    ...
    for (const g2 in u) {
      let x3 = false, q3;
      g2 in d2 ? (x3 = true, q3 = d2[g2], q3 === M && (q3 = u[g2])) : q3 = u[g2], b2(g2, q3, x3);
    }
    for (const g2 in d2) {
      if (g2 in u)
        continue;
  ...
  const c = D(n.$invocationContext$, i, t2.props, t2.key, t2.flags, t2.dev);
  return Is(c, t2) ? yn(ft(dt, { children: c }, 0, t2.key), e, n, s, r, o) : X(c, e, n, s, r, o);
};
var X = (t2, e, n, s, r, o) => {
  var i;
  if (t2 != null && typeof t2 != "boolean") {
    if (!ut(t2) && typeof t2 != "number") {
      ...
      if (C(t2)) {
        const $3 = 8 & r, c = (i = e.$cmpCtx$) == null ? void 0 : i.$element$;
        let l;
        if (c) {
          if (!$3) {
            const a = Gt(e);
            if (l = it(t2, 1024 & r ? [3, "#" + a, t2, "#" + a] : [4, c, t2, "#" + a]), ut(l)) {
              const u = Kt(l);
...
var Ns = (t2, e, n, s, r) => {
  ...
  let i = 0;
  const $3 = [];
  return t2.reduce((c, l, a) => {
    const u = [];
    $3.push(u);
    const d2 = X(l, e, n, c ? { write(p2) {
    ...
    if (c || L(d2)) {
      ...
      return L(d2) ? c ? Promise.all([d2, c]).then(p2) : d2.then(p2) : c.then(p2);
    }
    i++;
  }, void 0);
};
...
var vn = (t2, e, n) => {
  ...
  return o.$hostsStaging$.delete(e), o.$subsManager$.$clearSub$(r), k(de(t2, e), (i) => {
    const $3 = t2.$static$, c = i.rCtx, l = B(t2.$static$.$locale$, r);
    if ($3.$hostElements$.add(r), l.$subscriber$ = [0, r], l.$renderCtx$ = c, s && e.$appendStyles$)
      for (const u of e.$appendStyles$)
        Pi($3, u);
    const a = pt(i.node, l);
    return k(a, (u) => {
      const d2 = _o(r, u), p2 = wn(e);
      return k(we(c, p2, d2, n), () => {
        e.$vdom$ = d2;
      });
    });
  });
...
var Fs = (t2, e) => {
  ...
  let l = rt;
  return o != null ? k(pt(o, e), (a) => (a !== void 0 && (l = A(a) ? a : [a]), new ot(c, r, $3, l, i, n))) : new ot(c, r, $3, l, i, n);
};
var _o = (t2, e) => {
...
var ko = (t2) => {
  ...
  for (; c = a.nextNode(); ) {
    ...
    if (l === 0) {
      if (f2.startsWith("qv ")) {
        ...
        const y2 = f2.slice(2), S3 = j(y2), h2 = Ao(c);
  ...
  const d2 = Er(o, n), p2 = /* @__PURE__ */ new Map(), v3 = /* @__PURE__ */ new Set(), w2 = (f2) => (typeof f2 == "string" && f2.length > 0, p2.has(f2) ? p2.get(f2) : m2(f2)), m2 = (f2) => {
    if (f2.startsWith("#")) {
    ...
    S3.length > y2;
    let h2 = S3[y2];
    ut(h2) && (h2 = h2 === Fe ? void 0 : d2.prepare(h2));
    let b2 = h2;
    ...
    return p2.set(f2, b2), Qs(h2) || v3.has(y2) || (v3.add(y2), qo(h2, y2, e.subs, w2, o, d2), Us(h2, w2, d2)), b2;
  };
...
var qo = (t2, e, n, s, r, o) => {
  ...
  if (i) {
    ...
    for (const l of i)
      if (l.startsWith("_"))
        c = parseInt(l.slice(1), 10);
      else {
        const a = J$(l, s);
        a && $3.push(a);
      }
    if (c > 0 && Pe(t2, c), !o.subs(t2, $3)) {
      ...
      case 4: {
        ...
        if (!s.$visited$.includes(r)) {
          ...
          if (L(c))
            ...
            if (t2.$cmpCtx$ = U(a, t2.$static$.$containerState$), l.$type$ == c.$type$ && l.$key$ == c.$key$ && l.$id$ == c.$id$)
              It(t2, l, c, 0);
            else {
              const u = [], d2 = l.$elm$, p2 = wt(t2, c, 0, u);
              u.length && Et("Rendering promises in JSX signals is not supported"), $3[3] = p2, Pt(t2.$static$, r.parentElement, p2, d2), d2 && zn(s, d2);
            }
          }
        }
      }
...
var Hs = async (t2) => {
  ...
  try {
    ...
    t2.$hostsNext$.clear(), await Qo(t2, s), t2.$hostsStaging$.forEach((c) => {
      o.add(c);
    }), t2.$hostsStaging$.clear();
    const i = Array.from(t2.$opsNext$);
    t2.$opsNext$.clear();
    const $3 = Array.from(o);
    Bo($3), !t2.$styleMoved$ && $3.length > 0 && (t2.$styleMoved$ = true, (e === n.documentElement ? n.body : e).querySelectorAll("style[q\\:style]").forEach((c) => {
      t2.$styleIds$.add(Z(c, Ae)), pr(r, n.head, c);
    }));
    for (const c of $3) {
      const l = c.$element$;
      if (!r.$hostElements$.has(l) && c.$componentQrl$) {
        l.isConnected, r.$roots$.push(c);
        try {
          await vn(s, c, Fo(l.parentElement));
        } catch (a) {
          Et(a);
        }
      }
  ...
  const i = () => {
    if (s.forEach(($3) => {
      ...
      return Promise.all(r).then(async ($3) => {
        if (ge($3), await Promise.all($3.map((c) => ye(c, t2, e))), r.length = 0, --o && s.size > 0)
          return i();
...
var Go = (t2, e) => {
  ...
  if (n)
    return;
  const $3 = r.$renderCtx$.$static$.$containerState$, c = new _n(_t | Js, o, i.$element$, t2, void 0);
  s(true), t2.$resolveLazy$($3.$containerEl$), i.$tasks$ || (i.$tasks$ = []), i.$tasks$.push(c), ai(r, () => Ks(c, $3, r.$renderCtx$)), nt() && Zo(c, e == null ? void 0 : e.eagerness);
};
...
var Xo = (t2, e, n, s) => {
  ...
  const i = t2.$qrl$.getFn(r, () => {
    o.$clearSub$(t2);
  }), $3 = [], c = t2.$state$, l = le(c), a = { track: (f2, y2) => {
    if (W(f2)) {
      const h2 = B();
    ...
    let y2 = 0;
    y2 = f2 === "immutable" ? 1 / 0 : f2, c._cache = y2;
  }, previous: l._resolved };
  let u, d2, p2 = false;
  const v3 = (f2, y2) => !p2 && (p2 = true, f2 ? (p2 = true, c.loading = false, c._state = "resolved", c._resolved = y2, c._error = void 0, u(y2)) : (p2 = true, c.loading = false, c._state = "rejected", c._error = y2, d2(y2)), true);
  D(r, () => {
    c._state = "pending", c.loading = !nt(), c.value = new Promise((f2, y2) => {
      u = f2, d2 = y2;
    });
  }), t2.$destroy$ = We(() => {
...
var Ks = (t2, e, n) => {
  ...
  const c = { track: (l, a) => {
    if (W(l)) {
      const d2 = B();
      return d2.$subscriber$ = [0, t2], D(d2, l);
    }
    const u = Q(l);
...
var Yo = (t2, e, n) => {
  ...
  return Re(i, ($3) => Zs(() => {
    const c = t2.$state$;
    c[Yt] &= ~tr, c.untrackedValue = $3, c[tt].$notifySubs$();
  }), ($3) => {
    hn($3, s, n);
  });
};
...
var U = (t2, e) => {
  ...
  if (r) {
    const o = e.$pauseCtx$;
    if (s.$id$ = r, o) {
      const { getObject: i, meta: $3, refs: c } = o;
      if (ei(t2)) {
        const l = c[r];
        ...
        const a = $3[r];
        if (a) {
          const u = a.s, d2 = a.h, p2 = a.c, v3 = a.w;
...
var gi = (t2, e, n, s, r) => {
  let o = 0, i = 0, $3 = n.length - 1, c = n[0], l = n[$3], a = s.length - 1, u = s[0], d2 = s[a], p2, v3, w2;
  ...
  for (; o <= $3 && i <= a; )
    if (c == null)
      ...
      m2.push(It(t2, c, u, r)), c = n[++o], u = s[++i];
    else if (l.$id$ === d2.$id$)
      m2.push(It(t2, l, d2, r)), l = n[--$3], d2 = s[--a];
    else if (c.$key$ && c.$id$ === d2.$id$)
      c.$elm$, l.$elm$, m2.push(It(t2, c, d2, r)), Ni(f2, e, c.$elm$, l.$elm$), c = n[++o], d2 = s[--a];
    else if (l.$key$ && l.$id$ === u.$id$)
      c.$elm$, l.$elm$, m2.push(It(t2, l, u, r)), Pt(f2, e, l.$elm$, c.$elm$), l = n[--$3], u = s[++i];
    else {
      if (p2 === void 0 && (p2 = Ri(n, o, $3)), v3 = p2[u.$key$], v3 === void 0) {
        const S3 = wt(t2, u, r, m2);
        Pt(f2, e, S3, c == null ? void 0 : c.$elm$);
      } else if (w2 = n[v3], w2.$type$ !== u.$type$) {
        const S3 = wt(t2, u, r, m2);
        k(S3, (h2) => {
          Pt(f2, e, h2, c == null ? void 0 : c.$elm$);
        });
      } else
        m2.push(It(t2, w2, u, r)), n[v3] = void 0, w2.$elm$, Pt(f2, e, w2.$elm$, c.$elm$);
      u = s[++i];
    }
...
var It = (t2, e, n, s) => {
  ...
  const r = e.$elm$, o = n.$type$, i = t2.$static$, $3 = i.$containerState$, c = t2.$cmpCtx$;
  if (n.$elm$ = r, o === "#text") {
    i.$visited$.push(r);
    const d2 = n.$signal$;
    return d2 && (n.$text$ = Kt(it(d2, [4, c.$element$, d2, r]))), void gt(i, r, "data", n.$text$);
  }
  if (o === "#signal")
    return;
      ...
      for (const v3 in l) {
        ...
        if (v3 !== "ref")
          if (un(v3)) {
            ...
            C(w2) && (w2 = it(w2, [1, c.$element$, w2, r, v3])), v3 === "class" ? w2 = mn(w2, c) : v3 === "style" && (w2 = Le(w2)), p2[v3] !== w2 && (p2[v3] = w2, Nn(i, r, v3, w2, d2));
        else
          w2 !== void 0 && An(w2, r);
      }
    }
    return 2 & a || (d2 && o === "foreignObject" && (s &= ~J), l[F] !== void 0) || o === "textarea" ? void 0 : we(t2, e, n, s);
  }
  if ("q:renderFn" in l) {
    const d2 = l.props;
    Ti($3, u, d2);
    let p2 = !!(u.$flags$ & Ot);
    return p2 || u.$componentQrl$ || u.$element$.hasAttribute("q:id") || (ks(t2, u), u.$componentQrl$ = d2["q:renderFn"], u.$componentQrl$, p2 = true), p2 ? k(vn(t2, u, s), () => jn(t2, u, n, s)) : jn(t2, u, n, s);
  }
  if ("q:s" in l)
    return c.$slots$, void c.$slots$.push(n);
  if (F in l)
...
var jn = (t2, e, n, s) => {
  ...
  for (const $3 in i.templates) {
    const c = i.templates[$3];
    c && !o[$3] && (i.templates[$3] = void 0, zn(r, c));
  }
  return ln(Object.keys(o).map(($3) => {
    const c = o[$3], l = lr(r, i, e, $3, t2.$static$.$containerState$), a = wn(l), u = oe(t2), d2 = l.$element$;
    u.$slotCtx$ = l, l.$vdom$ = c, c.$elm$ = d2;
    let p2 = s & ~J;
    d2.isSvg && (p2 |= J);
    const v3 = r.$addSlots$.findIndex((w2) => w2[0] === d2);
    return v3 >= 0 && r.$addSlots$.splice(v3, 1), we(u, a, c, p2);
  }));
};
var cr = (t2, e, n, s, r, o, i) => {
  const $3 = [];
  for (; r <= o; ++r) {
    const c = s[r], l = wt(t2, c, i, $3);
    Pt(t2.$static$, e, l, n);
  }
  return Rt($3);
};
...
var lr = (t2, e, n, s, r) => {
  ...
  if (i)
    return U(i, r);
  const $3 = hr(t2.$doc$, s), c = Oe($3);
  return c.$parentCtx$ = n, Li(t2, n.$element$, $3), e.templates[s] = $3, c;
};
...
var wt = (t2, e, n, s) => {
  ...
  let $3, c = !!(n & J);
  c || r !== "svg" || (n |= J, c = true);
  const l = r === Dt, a = e.$props$, u = t2.$static$, d2 = u.$containerState$;
  l ? $3 = Wi(o, c) : r === "head" ? ($3 = o.head, n |= Se) : ($3 = Pn(o, r, c), n &= ~Se), 2 & e.$flags$ && (n |= 4), e.$elm$ = $3;
  const p2 = Oe($3);
  if (t2.$slotCtx$ ? (p2.$parentCtx$ = t2.$slotCtx$, p2.$realParentCtx$ = t2.$cmpCtx$) : p2.$parentCtx$ = t2.$cmpCtx$, l) {
    if ("q:renderFn" in a) {
      const m2 = a["q:renderFn"], f2 = Ne(), y2 = d2.$subsManager$.$createManager$(), S3 = new Proxy(f2, new Es(d2, y2)), h2 = a.props;
      if (d2.$proxyMap$.set(f2, S3), p2.$props$ = S3, h2 !== O) {
    ...
    if (a !== O) {
      ...
      e.$props$ = ns(u, p2, i, m2, c, false);
    }
    if (c && r === "foreignObject" && (c = false, n &= ~J), i) {
      const m2 = i.$scopeIds$;
      m2 && m2.forEach((f2) => {
        $3.classList.add(f2);
...
var ns = (t2, e, n, s, r, o) => {
  ...
  for (const c in s) {
    ...
    if (c !== "ref")
      if (un(c))
        dn(e.li, c, l, t2.$containerState$.$containerEl$);
      else {
        if (C(l) && (l = it(l, o ? [1, $3, l, n.$element$, c] : [2, n.$element$, l, $3, c])), c === "class") {
          if (l = mn(l, n), !l)
            continue;
        } else
          c === "style" && (l = Le(l));
...
var Rc = async (t2) => {
  ...
  return JSON.stringify({ _entry: $3(t2), _objs: c });
};
var Xi = async (t2) => {
  ...
  for (const u of i) {
    ...
    if (u.$scopeIds$) {
      ...
      v3 && d2.setAttribute("q:sstyle", v3);
    }
    if (u.$id$ && d2.setAttribute("q:id", u.$id$), St(d2) && p2.length > 0) {
      const v3 = fn(p2);
      for (const w2 of v3)
        d2.setAttribute(w2[0], Cn(w2[1], o, u));
    }
  }
  const $3 = await Yi(i, o, (u) => yt(u) && rn(u) ? c$(u, o) : null), c = e.createElement("script");
  V(c, "type", "qwik/json"), c.textContent = n$(JSON.stringify($3.state, void 0, void 0)), r.appendChild(c);
...
var Yi = async (t2, e, n, s) => {
  ...
  for (; (i = r.$promises$).length > 0; )
    r.$promises$ = [], await Promise.all(i);
  const c = /* @__PURE__ */ new Map(), l = Array.from(r.$objSet$.keys()), a = /* @__PURE__ */ new Map(), u = (h2) => {
    let b2 = "";
    if (L(h2)) {
      const g2 = yr(h2);
      if (!g2)
    ...
    if ($t(h2)) {
      ...
      if (g2)
        ...
        const x3 = ((q3) => {
          let R2 = c.get(q3);
          return R2 === void 0 && (R2 = $$(q3), R2 || console.warn("Missing ID", q3), c.set(q3, R2)), R2;
        })(h2);
...
var ji = (t2, e) => {
  ...
  if (n && s && !Sr(s) && e.$elements$.includes(n)) {
    ...
    if (o)
      for (const [$3, c] of o)
        $3 === 0 ? (c !== i && Ct(Q(s), e, false), yt(c) ? e$(c, e) : T(c, e, true)) : (T(s, e, false), Ct(Q(s), e, false));
  }
};
var gr = (t2) => {
  const e = [];
...
var Dn = (t2, e = {}) => {
  ...
  if (s.startsWith("./") && (s = s.slice(2)), X$(t2))
    if (e.$containerState$) {
      const u = e.$containerState$, d2 = t2.resolved.toString();
  ...
  let i = `${s}#${n}`;
  const $3 = t2.$capture$, c = t2.$captureRef$;
  return c && c.length ? e.$getObjId$ ? i += `[${bt(c, e.$getObjId$, " ")}]` : e.$addRefMap$ && (i += `[${bt(c, e.$addRefMap$, " ")}]`) : $3 && $3.length > 0 && (i += `[${$3.join(" ")}]`), i;
};
var Cn = (t2, e, n) => {
  n.$element$;
...
var Ce = (t2, e) => {
  const n = t2.length, s = is(t2, 0, "#"), r = is(t2, s, "["), o = Math.min(s, r), i = t2.substring(0, o), $3 = s == n ? s : s + 1, c = $3 == r ? "default" : t2.substring($3, r), l = r === n ? rt : t2.substring(r + 1, n - 1).split(" "), a = Ue(i, c, null, null, l, null, null);
  ...
  if (U$(r)) {
    ...
    switch (o) {
      case "object":
        ...
        if (ne(r)) {
          for (const [$3, c] of Object.entries(r))
            sn(c, e, n + "." + $3);
          return t2;
        }
        break;
  ...
  $unsubEntry$(e) {
    ...
    if (n === 1 || n === 2) {
      ...
      for (let c = 0; c < i.length; c++) {
        const l = i[c];
        l[0] === n && l[1] === s && l[2] === r && l[3] === o && l[4] === $3 && (i.splice(c, 1), c--);
      }
    } else if (n === 3 || n === 4)
      for (let $3 = 0; $3 < i.length; $3++) {
        const c = i[$3];
        c[0] === n && c[1] === s && c[2] === r && c[3] === o && (i.splice($3, 1), $3--);
      }
  }
  $addSub$(e, n) {
...
var Ue = (t2, e, n, s, r, o, i) => {
  ...
  const c = async function(...f2) {
    ...
    return S3 = B(), S3.$qrl$ = c, S3.$event$ = this, D.call(this, S3, f2, ...y2);
  }, u = async (f2) => {
    if (n !== null)
      return n;
    if (f2 && l(f2), t2 === "") {
      const h2 = $3.getAttribute(ys), b2 = Ss($3.ownerDocument, h2);
      return c.resolved = n = b2[Number(e)];
    }
    const y2 = j$(), S3 = Y();
    {
      const h2 = Ie().importSymbol($3, t2, e);
      n = k(h2, (b2) => c.resolved = n = a(b2));
    }
  ...
  return Object.assign(c, { getSymbol: () => w2, getHash: () => m2, getCaptured: () => o, resolve: u, $resolveLazy$: d2, $setContainer$: l, $chunk$: t2, $symbol$: e, $refSymbol$: i, $hash$: m2, getFn: p2, $capture$: r, $captureRef$: o, dev: null, resolved: void 0 }), n && (n = k(n, (f2) => c.resolved = n = a(f2))), c;
};
var Ir = (t2) => {
...
var nc = (t2, e, n) => {
  ...
  if (s)
    return s;
  const c = to(t2, i), l = o.$renderCtx$.$static$.$containerState$;
  if (r(c), $3.$appendStyles$ || ($3.$appendStyles$ = []), $3.$scopeIds$ || ($3.$scopeIds$ = []), l.$styleIds$.has(c))
    return c;
  l.$styleIds$.add(c);
  const a = t2.$resolveLazy$(l.$containerEl$), u = (d2) => {
    $3.$appendStyles$, $3.$appendStyles$.push({ styleId: c, content: e(d2, c) });
  };
  return L(a) ? o.$waitOn$.push(a.then(u)) : u(a), c;
};
...
var vc = async (t2, e) => {
  const [n, s, r, o] = bn(), { type: i = "link", forceReload: $3 = t2 === void 0, replaceState: c = false, scroll: l = true } = typeof e == "object" ? e : { forceReload: e };
  if (typeof t2 == "number")
    return;
  const a = r.value.dest, u = t2 === void 0 ? a : uc(t2, o.url);
  if (fc(u, a) && !(!$3 && hc(u, a)))
    return r.value = { type: i, dest: u, forceReload: $3, replaceState: c, scroll: l }, n.value = void 0, o.isNavigating = true, new Promise((d2) => {
      s.r = d2;
    });
};
var wc = ({ track: t2 }) => {
  const [e, n, s, r, o, i, $3, c, l, a, u] = bn();
  async function d2() {
...
var bc = (t2) => {
  ...
  const s = new URL(n), r = ae({ url: s, params: e.params, isNavigating: false, prevUrl: void 0 }, { deep: false }), o = {}, i = B$(ae(e.response.loaders, { deep: false })), $3 = He({ type: "initial", dest: s, forceReload: false, replaceState: false, scroll: true }), c = ae(Pr), l = ae({ headings: void 0, menu: void 0 }), a = He(), u = e.response.action, d2 = u ? e.response.loaders[u] : void 0, p2 = He(d2 ? { id: u, data: e.response.formData, output: { result: d2, status: e.response.status } } : void 0), v3 = Vt(vc, "s_fX0bDjeJa0E", [p2, o, $3, r]);
  return lt(rc, l), lt(Ar, a), lt(Mr, c), lt(Nr, r), lt(oc, v3), lt(Rr, i), lt(ic, p2), lt($c, $3), Go(Vt(wc, "s_02wMImzEAbk", [p2, l, a, c, e, v3, i, o, t2, $3, r])), ft(_e, null, 3, "qY_0");
};
...
// ../server/assets/entry.ssr-ZtZ2nsI1.js
var be2 = ((t2) => typeof __require < "u" ? __require : typeof Proxy < "u" ? new Proxy(t2, { get: (e, n) => (typeof __require < "u" ? __require : e)[n] }) : t2)(function(t2) {
...
function Z2(t2, e) {
  const n = e == null ? void 0 : e.mapper, s = t2.symbolMapper ? t2.symbolMapper : (o, a, i) => {
    ...
    if (n) {
      ...
      if (!p2) {
        if (l === qe2)
          return [l, ""];
        if ((c = globalThis.__qwik_reg_symbols) == null ? void 0 : c.has(l))
          return [o, "_"];
        if (i)
          return [o, `${i}?qrl=${o}`];
  ...
  return { isServer: true, async importSymbol(o, a, i) {
    var w2;
    const c = z(i), l = (w2 = globalThis.__qwik_reg_symbols) == null ? void 0 : w2.get(c);
    if (l)
      return l;
    let p2 = String(a);
...
function te2(t2, e, n, s, r) {
  ...
  if (!a) {
    ...
    if (i && Array.isArray(i.imports))
      for (const c of i.imports)
        te2(t2, e, a.imports, s, c);
  }
  n.push(a);
}
function ke2(t2) {
  ...
  const s = (i, c) => {
    if (Array.isArray(i))
      for (const l of i) {
        ...
        e.set(l.url, p2 + 1), n++, c.has(l.url) || (c.add(l.url), s(l.imports, c));
      }
  }, r = /* @__PURE__ */ new Set();
  for (const i of t2)
    r.clear(), s(i.imports, r);
  const o = n / e.size * 2, a = Array.from(e.entries());
  return a.sort((i, c) => c[1] - i[1]), a.slice(0, 5).filter((i) => i[1] > o).map((i) => i[0]);
}
function ze2(t2, e, n, s) {
  const r = Be2(e == null ? void 0 : e.implementation), o = [];
  return r.prefetchEvent === "always" && Se2(t2, o, n, s), r.linkInsert === "html-append" && Ee2(o, n, r), r.linkInsert === "js-append" ? Ce2(o, n, r, s) : r.workerFetchInsert === "always" && Pe2(o, n, s), o.length > 0 ? qc(me, { children: o }) : null;
}
...
var De2 = { linkInsert: null, linkRel: null, workerFetchInsert: null, prefetchEvent: "always" };
var Ae2 = "q:instance";
var Le2 = "<!DOCTYPE html>";
async function Te2(t2, e) {
  var T4, F4, O3;
  let n = e.stream, s = 0, r = 0, o = 0, a = 0, i = "", c;
  const l = ((T4 = e.streaming) == null ? void 0 : T4.inOrder) ?? { strategy: "auto", maximunInitialChunk: 5e4, maximunChunk: 3e4 }, p2 = e.containerTagName ?? "html", y2 = e.containerAttributes ?? {}, w2 = n, oe3 = N2(), se3 = ee2(e), u = ne2(e.manifest);
  function C3() {
  ...
  const re3 = N2(), D4 = [];
  let A3 = 0, L4 = 0;
  await _c(t2, { stream: n, containerTagName: p2, containerAttributes: y2, serverData: e.serverData, base: se3, beforeContent: j4, beforeClose: async (m2, f2, K3, I3) => {
    var M4, Q4, R2, Y4, $3;
    A3 = re3();
    const q3 = N2();
    c = await Yi(m2, f2, void 0, I3);
    const b2 = [];
    if (e.prefetchStrategy !== null) {
      const h2 = ve2(c, e, u), le3 = y2["q:base"];
      if (h2.length > 0) {
        const J4 = ze2(le3, e.prefetchStrategy, h2, (M4 = e.serverData) == null ? void 0 : M4.nonce);
        J4 && b2.push(J4);
      }
    }
    const ae3 = JSON.stringify(c.state, void 0, void 0);
    if (b2.push(qc("script", { type: "qwik/json", dangerouslySetInnerHTML: Oe2(ae3), nonce: (Q4 = e.serverData) == null ? void 0 : Q4.nonce })), c.funcs.length > 0) {
      const h2 = y2[Ae2];
      b2.push(qc("script", { "q:func": "qwik/json", dangerouslySetInnerHTML: We2(h2, c.funcs), nonce: (R2 = e.serverData) == null ? void 0 : R2.nonce }));
    }
    const ce3 = !c || c.mode !== "static", H3 = k4 === "always" || k4 === "auto" && ce3;
    if (H3) {
      const h2 = U2({ debug: e.debug });
      b2.push(qc("script", { id: "qwikloader", dangerouslySetInnerHTML: h2, nonce: (Y4 = e.serverData) == null ? void 0 : Y4.nonce }));
    }
    const W4 = Array.from(f2.$events$, (h2) => JSON.stringify(h2));
    if (W4.length > 0) {
      const h2 = (H3 ? "window.qwikevents" : "(window.qwikevents||=[])") + `.push(${W4.join(", ")})`;
      b2.push(qc("script", { dangerouslySetInnerHTML: h2, nonce: ($3 = e.serverData) == null ? void 0 : $3.nonce }));
    }
    return Ke2(D4, m2), L4 = q3(), qc(me, { children: b2 });
  }, manifestHash: (u == null ? void 0 : u.manifest.manifestHash) || "dev" + Fe2() }), p2 !== "html" && n.write("<!--/cq-->"), C3();
  const ie3 = c.resources.some((m2) => m2._cache !== 1 / 0);
  return { prefetchResources: void 0, snapshotResult: c, flushes: o, manifest: u == null ? void 0 : u.manifest, size: r, isStatic: !ie3, timing: { render: A3, snapshot: L4, firstFlush: a }, _symbols: D4 };
}
function Fe2() {
...
var Oe2 = (t2) => t2.replace(/<(\/?script)/gi, "\\x3C$1");
function Ke2(t2, e) {
  var n;
  for (const s of e) {
...
var W2 = 702;
var Z3 = 528;
var X2 = { srcSet: K2, width: W2, height: Z3 };
function $(u, i, o, r) {
  return xt("img", { decoding: "async", loading: "lazy", ...u }, X2, void 0, 3, i);
}
var J2 = () => xt("section", null, { id: "process", class: "container" }, [xt("div", null, { class: "images" }, [xt("div", null, { class: "wrap slide-1" }, ft($, { alt: "image random", [M]: { alt: M } }, 3, "Wn_0"), 1, null), xt("div", null, { class: "navigation" }, [xt("button", null, { class: "prev" }, null, 3, null), xt("button", null, { class: "next" }, null, 3, null)], 3, null), xt("div", null, { class: "pagination" }, [xt("span", null, null, null, 3, null), xt("span", null, null, null, 3, null), xt("span", null, null, null, 3, null), xt("span", null, null, null, 3, null), xt("span", null, null, null, 3, null)], 3, null)], 1, null), xt("div", null, { class: "text" }, [xt("h4", null, null, "LA FINALITE", 3, null), xt("h5", null, null, "| CHAQUE CHRETIEN DEVIENT UN MISSIONNAIRE", 3, null), xt("p", null, null, "Si les chr\xE9tiens s\u2019approprient et appliquent l\u2019\xE9vangile, l\u2019objectif de Dieu sera accompli. La r\xE9alisation de cela sera un immense devoir, mais c\u2019est un imp\xE9ratif pour que ses messages soient accomplis.", 3, null)], 3, null)], 1, "Wn_1");
var S2 = Wn(Vt(J2, "s_AHXCM5MQEBQ"));
var ll = Object.freeze(Object.defineProperty({ __proto__: null, Process: S2 }, Symbol.toStringTag, { value: "Module" }));
var nl = () => xt("section", null, { id: "way", class: "container" }, xt("div", null, { class: "content" }, [xt("div", null, { class: "titles" }, [xt("div", null, { class: "doctrine" }, [xt("h5", null, null, "NOTRE PHILOSOPHIE", 3, null), xt("p", null, null, "| MALAGASY PRECHE L\u2019EVANGILE AU PEUPLE MALAGASY, SOUTENU PAR DES MALAGASY ET PR\xD4NE L\u2019ENTRE AIDE", 3, null)], 3, null), xt("div", null, { class: "how" }, [xt("h5", null, null, "NOTRE APPROCHE", 3, null), xt("p", null, null, "| PROCESSUS DE DEVELOPPEMENT HOLISTIQUE ADAPTE AUX VALEURS MALAGASY", 3, null)], 3, null)], 3, null), xt("div", null, { class: "separation" }, null, 3, null), xt("p", null, null, "Effectivement, les missionnaires de l\u2019Ouest, porteur de l\u2019\xE9vangile \xE0 Madagascar, a transmis la lumi\xE8re. Ils ont accomplis leurs responsabilit\xE9s, les \xE9glises malagasy d\xE9ploient l\u2019effort n\xE9cessaire pour assurer le relais. \xAB On ne pourra pas b\xE2tir une maison avec une seule main \xBB, chaque appui sera la bienvenue. Real Mission Movement ne incarnera jamais, comme l\u2019adage malagasy stipule \xAB comme la rivi\xE8re de l\u2019Ikopa, en accueillant ses amis, elle vire en jaune \xBB", 3, null)], 3, null), 3, "C0_0");
var v2 = Wn(Vt(nl, "s_YjpPC49tZf8"));
var el = Object.freeze(Object.defineProperty({ __proto__: null, Way: v2 }, Symbol.toStringTag, { value: "Module" }));
var sl = () => xt("section", null, { id: "c-t-a" }, [xt("h3", null, null, "NOTRE STRATEGIE 2024 - 2028", 3, null), xt("a", null, { href: "/" }, "Voir plus", 3, null)], 3, "G6_0");
var _ = Wn(Vt(sl, "s_J3B01Iq9kho"));
var tl = Object.freeze(Object.defineProperty({ __proto__: null, CallToAction: _ }, Symbol.toStringTag, { value: "Module" }));
var ul = () => ft(me, { children: [ft(m, null, 3, "H1_0"), ft(E, null, 3, "H1_1"), ft(S2, null, 3, "H1_2"), ft(v2, null, 3, "H1_3"), ft(h, null, 3, "H1_4"), ft(_, null, 3, "H1_5")] }, 1, "H1_6");
var al = Wn(Vt(ul, "s_xYL1qOwPyDI"));
var il = { title: "Real Mission Movement", meta: [{ name: "description", content: "Missionnaire" }] };
var ol = Object.freeze(Object.defineProperty({ __proto__: null, default: al, head: il }, Symbol.toStringTag, { value: "Module" }));
var rl = "/assets/002-DiKwCPM6.webp 200w, /assets/002-PGTWYyiM.webp 400w, /assets/002-Blm0xqJy.webp 600w, /assets/002-C5Px8EEg.webp 800w, /assets/002-BgdZ8RTN.webp 1042w";
var cl = 1042;
var dl = 2043;
var pl = { srcSet: rl, width: cl, height: dl };
function gl(u, i, o, r) {
  return xt("img", { decoding: "async", loading: "lazy", ...u }, pl, void 0, 3, i);
}
var ml = () => xt("section", null, { id: "action", class: "container" }, [xt("div", null, { class: "sites" }, [xt("h5", null, null, "NOS SITES D'ACTION", 3, null), xt("div", null, { class: "mada" }, ft(gl, { alt: "map of madagascar", [M]: { alt: M } }, 3, "5b_0"), 1, null)], 1, null), xt("div", null, { class: "content" }, [xt("div", null, { class: "wrapper" }, [xt("div", null, { class: "title" }, [xt("h5", null, null, "NOS OBJECTIFS STRATEGIQUES", 3, null), xt("h5", null, null, "1/3", 3, null)], 3, null), xt("div", null, { class: "slider" }, xt("div", null, { class: "slide" }, [xt("div", null, null, xt("p", null, null, "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, eaque magni quam quo nesciunt tempora earum ipsa culpa itaque ratione!", 3, null), 3, null), xt("div", null, null, xt("p", null, null, "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, eaque magni quam quo nesciunt tempora earum ipsa culpa itaque ratione!", 3, null), 3, null), xt("div", null, null, xt("p", null, null, "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, eaque magni quam quo nesciunt tempora earum ipsa culpa itaque ratione!", 3, null), 3, null), xt("div", null, null, xt("p", null, null, "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, eaque magni quam quo nesciunt tempora earum ipsa culpa itaque ratione!", 3, null), 3, null)], 3, null), 3, null), xt("div", null, { class: "navigation" }, [xt("button", null, { class: "prev" }, null, 3, null), xt("button", null, { class: "next" }, null, 3, null)], 3, null)], 3, null), xt("div", null, { class: "wrapper" }, [xt("div", null, { class: "title" }, [xt("h5", null, null, "NOS OBJECTIFS STRATEGIQUES", 3, null), xt("h5", null, null, "1/3", 3, null)], 3, null), xt("div", null, { class: "slider" }, xt("div", null, { class: "slide" }, [xt("div", null, null, xt("p", null, null, "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, eaque magni quam quo nesciunt tempora earum ipsa culpa itaque ratione!", 3, null), 3, null), xt("div", null, null, xt("p", null, null, "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, eaque magni quam quo nesciunt tempora earum ipsa culpa itaque ratione!", 3, null), 3, null), xt("div", null, null, xt("p", null, null, "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, eaque magni quam quo nesciunt tempora earum ipsa culpa itaque ratione!", 3, null), 3, null), xt("div", null, null, xt("p", null, null, "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, eaque magni quam quo nesciunt tempora earum ipsa culpa itaque ratione!", 3, null), 3, null)], 3, null), 3, null), xt("div", null, { class: "navigation" }, [xt("button", null, { class: "prev" }, null, 3, null), xt("button", null, { class: "next" }, null, 3, null)], 3, null)], 3, null)], 3, null)], 1, "5b_1");
var w = Wn(Vt(ml, "s_vogN4rSb0Pw"));
var hl = Object.freeze(Object.defineProperty({ __proto__: null, Action: w }, Symbol.toStringTag, { value: "Module" }));
var El = "/assets/003-DX8tLrSS.webp 200w, /assets/003-DdzD-Bny.webp 400w, /assets/003-BdLkF6P8.webp 600w, /assets/003-CEHQcgkG.webp 800w, /assets/003-B_szyRgV.webp 1080w";
var Sl = 1080;
var vl = 720;
var _l = { srcSet: El, width: Sl, height: vl };
function wl(u, i, o, r) {
  return xt("img", { decoding: "async", loading: "lazy", ...u }, _l, void 0, 3, i);
}
var bl = () => xt("section", null, { id: "effect", class: "container" }, [xt("div", null, { class: "image" }, ft(wl, { alt: "standing dudes with micros", [M]: { alt: M } }, 3, "0f_0"), 1, null), xt("div", null, { class: "text" }, [xt("h4", null, null, "EFFETS ATTENDUS", 3, null), xt("div", null, null, xt("p", null, null, "Que chaque m\xE9nage s'approprie de l'\xE9vangile et l'utilise pour reprendre des d\xE9cisions de croissance et d'\xE9panouissement durable de chaque membre de la famille.", 3, null), 3, null), xt("div", null, null, xt("p", null, null, "Que l'\xE9vangile soit adopt\xE9 par les leaders de tout les niveaux comme un outil de leadership et de management de d\xE9veloppement communautaire.", 3, null), 3, null)], 3, null)], 1, "0f_1");
var b = Wn(Vt(bl, "s_d2YD27NjK04"));
var fl = Object.freeze(Object.defineProperty({ __proto__: null, Effect: b }, Symbol.toStringTag, { value: "Module" }));
var Cl = () => xt("section", null, { id: "impact", class: "container" }, [xt("div", null, { class: "impact" }, [xt("h4", null, null, "IMPACT", 3, null), xt("p", null, null, "L\u2019EVANGILE SERA UNE VALEURE CONSTITUANT L\u2019IDENTITE DES MALAGASY, SE TRANSMET DE GENERATION EN GENERATION ET GARANT D\u2019UN DEVELOPPEMENT HARMONIEUX ET DURABLE POUR LA NATION", 3, null)], 3, null), xt("div", null, { class: "goal" }, [xt("h4", null, null, "LE BUT", 3, null), xt("p", null, null, "PROMOUVOIR UN CHANGEMENT DE PENSEE, UN CHANGEMENT DE FAIRE ET DE MANI\xC8RE ET UN CHANGEMENT DE COMPORTEMENT", 3, null)], 3, null)], 3, "ub_0");
var f = Wn(Vt(Cl, "s_9TN4mgqwxTI"));
var Tl = Object.freeze(Object.defineProperty({ __proto__: null, Impact: f }, Symbol.toStringTag, { value: "Module" }));
var Ol = () => xt("section", null, { id: "orientation", class: "container" }, [xt("h4", null, null, "ORIENTATIONS STRATEGIQUES", 3, null), xt("div", null, { class: "list" }, [xt("div", null, null, [xt("h3", null, null, "ORIENTATION 01", 3, null), xt("p", null, null, "DEVELOPPER LES CAPACITES DE MISE EN \u0152UVRE DU RMM", 3, null)], 3, null), xt("div", null, null, [xt("h3", null, null, "ORIENTATION 02", 3, null), xt("p", null, null, "DEPLOYER L\u2019EVANGILE JUSQU'AUX COMMUNAUTES LOCALES DE BASE", 3, null)], 3, null), xt("div", null, null, [xt("h3", null, null, "ORIENTATION 03", 3, null), xt("p", null, null, "RENFORCER LES MOYENS D\u2019EXISTANCE ET DE SUBSISTANCE AU NIVEAU LOCAL", 3, null)], 3, null)], 3, null)], 3, "54_0");
var C2 = Wn(Vt(Ol, "s_aCk68v0g98Q"));
var Nl = Object.freeze(Object.defineProperty({ __proto__: null, Orientation: C2 }, Symbol.toStringTag, { value: "Module" }));
var Al = () => xt("section", null, { id: "strathero" }, xt("h2", null, null, "NOTRE STRATEGIE 2024 - 2028", 3, null), 3, "vQ_0");
var T2 = Wn(Vt(Al, "s_fWEWWqrFWbY"));
var Ll = Object.freeze(Object.defineProperty({ __proto__: null, StratHero: T2 }, Symbol.toStringTag, { value: "Module" }));
var Rl = () => ft(me, { children: [ft(T2, null, 3, "fZ_0"), ft(f, null, 3, "fZ_1"), ft(b, null, 3, "fZ_2"), ft(C2, null, 3, "fZ_3"), ft(w, null, 3, "fZ_4")] }, 1, "fZ_5");
var Il = Wn(Vt(Rl, "s_nJji05J2H7s"));
var Ml = { title: "Strategie", meta: [{ name: "description", content: "Missionnaire" }] };
var ql = Object.freeze(Object.defineProperty({ __proto__: null, default: Il, head: Ml }, Symbol.toStringTag, { value: "Module" }));
var Pl = [];
var t = () => y;
var jl = [["/", [t, () => ol], "/", ["q-BkbC9xaK.js", "q-yOLSW52x.js"]], ["pages/strategie/action/", [t, () => hl], "/pages/strategie/action/", ["q-BkbC9xaK.js", "q-DvKM7wYC.js"]], ["pages/strategie/effect/", [t, () => fl], "/pages/strategie/effect/", ["q-BkbC9xaK.js", "q-TFIicnb1.js"]], ["pages/strategie/impact/", [t, () => Tl], "/pages/strategie/impact/", ["q-BkbC9xaK.js", "q-B4XL7z7S.js"]], ["pages/strategie/orientation/", [t, () => Nl], "/pages/strategie/orientation/", ["q-BkbC9xaK.js", "q-C5IHMgCG.js"]], ["pages/strategie/stratHero/", [t, () => Ll], "/pages/strategie/stratHero/", ["q-BkbC9xaK.js", "q-BoG0iQUP.js"]], ["pages/strategie/", [t, () => ql], "/pages/strategie/", ["q-BkbC9xaK.js", "q-BYD5gTO-.js"]], ["sections/c-t-a/", [t, () => tl], "/sections/c-t-a/", ["q-BkbC9xaK.js", "q-DL3mFo3S.js"]], ["sections/founder/", [t, () => F2], "/sections/founder/", ["q-BkbC9xaK.js", "q-C4RqTdix.js"]], ["sections/goal/", [t, () => z2], "/sections/goal/", ["q-BkbC9xaK.js", "q-BwmutnWS.js"]], ["sections/hero/", [t, () => G2], "/sections/hero/", ["q-BkbC9xaK.js", "q-OPTCbu0N.js"]], ["sections/process/", [t, () => ll], "/sections/process/", ["q-BkbC9xaK.js", "q-BgStDghK.js"]], ["sections/way/", [t, () => el], "/sections/way/", ["q-BkbC9xaK.js", "q-C3VpEgNo.js"]]];
var xl = [];
var yl = true;
var Dl = "/";
var Gl = true;
var kl = { routes: jl, serverPlugins: Pl, menus: xl, trailingSlash: yl, basePathname: Dl, cacheModules: Gl };
...
function we3(e, t2) {
  ...
  const n = typeof t2 == "string" ? "600px" : "300px", r = e >= 500 ? Je2 : Ge3;
  return `
<head>
  <meta charset="utf-8">
...
var Ze2 = class {
  constructor(e) {
    this[Se3] = {}, this[be3] = {}, this.appendCounter = 0, this[M3] = Xe3(e), this[_2] = { ...this[M3] };
  }
  get(e, t2 = true) {
...
function Re3(e, t2, n, r, a, i) {
  ...
  for (; t2 < n; ) {
    ...
    if (o === 91) {
      const c = Ae3(e, t2), f2 = t2 + (c ? 3 : 0), h2 = Y3(e, f2, n, 93), m2 = e.substring(f2, h2), d2 = Y3(e, h2 + 1, n, 47), g2 = e.substring(h2 + 1, d2);
      t2 = h2 + 1;
      const y2 = a - 1;
      if (c) {
        const C3 = tt2(m2, g2, r, y2, i, e, t2 + g2.length + 1, n);
        if (C3)
          return Object.assign(s || (s = {}), C3);
      }
...
function tt2(e, t2, n, r, a, i, s, o) {
  ...
  for (; l >= r; ) {
    ...
    if (f2) {
      ...
      return m2.endsWith(c) && (m2 = m2.substring(0, m2.length - c.length)), f2[e] = decodeURIComponent(m2), f2;
    }
    const h2 = nt2(n, r, c, l, r - 1) + c.length;
    if (l === h2)
      break;
    l = h2;
  }
...
var rt2 = async (e, t2, n, r) => {
  ...
  for (const a of e) {
    ...
    if (!s)
      continue;
    const o = a[1], l = a[3], c = new Array(o.length), f2 = [];
    o.forEach((d2, g2) => {
      le2(d2, f2, (y2) => c[g2] = y2, n);
    });
    const h2 = at2(t2, r);
    let m2;
    return le2(h2, f2, (d2) => m2 = d2 == null ? void 0 : d2.default, n), f2.length > 0 && await Promise.all(f2), [i, s, c, m2, l];
  }
  return null;
};
var le2 = (e, t2, n, r) => {
...
function st(e, t2, n, r, a = true, i = "/", s) {
  let o;
  const l = new Promise((f2) => o = f2), c = ft2(e, t2, n, r, a, i, s, o);
  return { response: l, requestEv: c, completion: L3 ? L3.run(c, fe2, c, o) : fe2(c, o) };
}
...
function ft2(e, t2, n, r, a, i, s, o) {
  const { request: l, platform: c, env: f2 } = e, h2 = /* @__PURE__ */ new Map(), m2 = new Ze2(l.headers.get("cookie")), d2 = new Headers(), g2 = new URL(l.url);
  ...
  let y2 = -1, w2 = null, A3, C3 = e.locale, S3 = 200;
  const Oe3 = async () => {
    for (y2++; y2 < n.length; ) {
    ...
    return K3();
  }, K3 = () => (y2 = ue2, new Z4()), B3 = {}, R2 = { [_e3]: B3, [xe3]: e.mode, [De3]: a, [Ce3]: t2, [Q3]: s, cookie: m2, headers: d2, env: f2, method: l.method, signal: l.signal, params: (t2 == null ? void 0 : t2[1]) ?? {}, pathname: g2.pathname, platform: c, query: g2.searchParams, request: l, url: g2, basePathname: i, sharedMap: h2, get headersSent() {
    return w2 !== null;
  }, get exited() {
    return y2 >= ue2;
  }, get clientConn() {
    ...
    if (u.__brand === "server_loader" && !(p2 in B3))
      throw new Error("You can not get the returned data of a loader that has not been executed for this request.");
    return B3[p2];
  }, status: (u) => typeof u == "number" ? (P3(), S3 = u, u) : S3, locale: (u) => (typeof u == "string" && (C3 = u), C3 || ""), error: (u, p2) => (S3 = u, d2.delete("Cache-Control"), new ye2(u, p2)), redirect: (u, p2) => {
    if (P3(), S3 = u, p2) {
      const b2 = p2.replace(/([^:])\/{2,}/g, "$1/");
      p2 !== b2 && console.warn(`Redirect URL ${p2} is invalid, fixing to ${b2}`), d2.set("Location", b2);
    }
    return d2.delete("Cache-Control"), u > 301 && d2.set("Cache-Control", "no-store"), K3(), new I2();
  }, defer: (u) => typeof u == "function" ? u : () => u, fail: (u, p2) => (P3(), S3 = u, d2.delete("Cache-Control"), { failed: true, ...p2 }), text: (u, p2) => (d2.set("Content-Type", "text/plain; charset=utf-8"), N3(u, p2)), html: (u, p2) => (d2.set("Content-Type", "text/html; charset=utf-8"), N3(u, p2)), parseBody: async () => A3 !== void 0 ? A3 : A3 = dt2(R2, h2, s), json: (u, p2) => (d2.set("Content-Type", "application/json; charset=utf-8"), N3(u, JSON.stringify(p2))), send: N3, isDirty: () => w2 !== null, getWritableStream: () => {
    if (w2 === null) {
      if (e.mode === "dev") {
        const u = h2.get("@serverTiming");
        u && d2.set("Server-Timing", u.map((p2) => `${p2[0]};dur=${p2[1]}`).join(","));
      }
      w2 = e.getWritableStream(S3, d2, m2, o, R2);
    }
    return w2;
  } };
...
function pt2(e) {
  ...
  const o = e.sharedMap.get(z3), l = e.sharedMap.get(Me3), c = e.sharedMap.get(Pe3), f2 = e.sharedMap.get(lt2), h2 = e.request.headers, m2 = new URL(t2.pathname + t2.search, t2), d2 = h2.get("X-Forwarded-Host"), g2 = h2.get("X-Forwarded-Proto");
  return d2 && (m2.port = "", m2.host = d2), g2 && (m2.protocol = g2), { url: m2.href, requestHeaders: s, locale: i(), nonce: f2, containerAttributes: { "q:route": c }, qwikcity: { routeName: c, ev: e, params: { ...n }, loadedRoute: ut2(e), response: { status: a(), loaders: j3(e), action: o, formData: l } } };
}
var mt2 = (e, t2, n, r, a) => {
...
var de2 = (e, t2, n, r, a, i) => {
  for (const s of r) {
    ...
    if (typeof o == "function" ? n.push(o) : Array.isArray(o) && n.push(...o), a) {
      ...
      e.push(...l);
      const c = Object.values(s).filter((f2) => he2(f2, "server_action"));
      t2.push(...c);
    }
  }
};
...
Make sure your <form> has method="POST" attribute, like this: <form method="POST">`), r === "POST") {
      ...
      if (o) {
        const l = globalThis._qwikActionsMap, c = e.find((f2) => f2.__id === o) ?? (l == null ? void 0 : l.get(o));
        if (c) {
          ...
          const h2 = await pe2(n, c.__validators, f2, i);
          if (!h2.success)
            a[o] = n.fail(h2.status ?? 500, h2.error);
          else {
            const m2 = i ? await U4(n, c.__qrl.getSymbol().split("_", 1)[0], () => c.__qrl.call(n, h2.data, n)) : await c.__qrl.call(n, h2.data, n);
            i && F3(s, m2, c.__qrl), a[o] = m2;
          }
        }
      }
    }
    if (t2.length > 0) {
      const o = t2.map((l) => {
        const c = l.__id;
        return a[c] = pe2(n, l.__validators, void 0, i).then((f2) => f2.success ? i ? U4(n, l.__qrl.getSymbol().split("_", 1)[0], () => l.__qrl.call(n, n)) : l.__qrl.call(n, n) : n.fail(f2.status ?? 500, f2.error)).then((f2) => (typeof f2 == "function" ? a[c] = f2() : (i && F3(s, f2, l.__qrl), a[c] = f2), f2)), a[c];
      });
      await Promise.all(o);
    }
  };
...
function Tt2(e) {
  return async (t2) => {
    ...
    const a = q2(t2), { readable: i, writable: s } = new TextEncoderStream(), o = t2.getWritableStream(), l = i.pipeTo(o, { preventClose: true }), c = s.getWriter(), f2 = t2.status();
    try {
      const h2 = G3(t2) === "static", m2 = pt2(t2), d2 = await e({ base: t2.basePathname + "build/", stream: c, serverData: m2, containerAttributes: { "q:render": h2 ? "static" : "", ...m2.containerAttributes } }), g2 = { loaders: j3(t2), action: t2.sharedMap.get(z3), status: f2 !== 200 ? f2 : 200, href: ke3(t2.url, a) };
      typeof d2.html == "string" && await c.write(d2.html), t2.sharedMap.set("qData", g2);
    } finally {
...
async function xt2(e) {
  ...
  e.request.headers.forEach((c, f2) => c), e.headers.set("Content-Type", "application/json; charset=utf-8");
...
async function Pt2(e, t2, n) {
  const { render: r, qwikCityPlan: a, manifest: i, checkOrigin: s } = t2, o = e.url.pathname, l = ot2(o, a.trailingSlash), c = await Mt2(a, l, e.request.method, s ?? true, r);
  if (c) {
    const [f2, h2] = c;
...
async function Mt2(e, t2, n, r, a) {
  const { routes: i, serverPlugins: s, menus: o, cacheModules: l } = e, c = await rt2(i, o, l, t2), f2 = mt2(s, c, n, r, Tt2(a));
  return f2.length > 0 ? [c, f2] : null;
}
var x2;
var k3;
var O2;
...
var kt2 = (ge2 = class {
  constructor() {
    ...
    $2(this, O2, new TransformStream({ transform: (e, t2) => {
      e = String(e);
      let n = "";
  ...
  get readable() {
    return T3(this, O2).readable;
  }
  get writable() {
    return T3(this, O2).writable;
  }
  get [Symbol.toStringTag]() {
    return "TextEncoderStream";
  }
}, x2 = /* @__PURE__ */ new WeakMap(), k3 = /* @__PURE__ */ new WeakMap(), O2 = /* @__PURE__ */ new WeakMap(), ge2);
function Ot2(e) {
  try {
  ...
  async function n(r, a, i) {
    try {
      ...
      if (c) {
        const d2 = await c.match(l);
        if (d2)
          return d2;
      }
      const h2 = await Pt2({ mode: "server", locale: void 0, url: s, request: r, env: { get(d2) {
        return a[d2];
      } }, getWritableStream: (d2, g2, y2, w2) => {
        const { readable: A3, writable: C3 } = new TransformStream(), S3 = new Response(A3, { status: d2, headers: qe3(g2, y2) });
        return w2(S3), C3;
      ...
      if (h2) {
        ...
        const d2 = await h2.response;
        if (d2)
          return d2.ok && c && d2.headers.has("Cache-Control") && i.waitUntil(c.put(l, d2.clone())), d2;
      }
...
var Lt2 = Ot2({ render: Ge2, qwikCityPlan: kl, manifest: Me2 });
...
// ../.wrangler/tmp/bundle-41aHaD/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-41aHaD/middleware-loader.entry.ts
...
*/
//# sourceMappingURL=bundledWorker-0.882043512343982.mjs.map
